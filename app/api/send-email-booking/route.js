        ...
        <html>
          <body>
            ...
            <table>
              ...
              <tr><td><strong>Location:</strong></td><td>${formData.location || 'N/A'}</td></tr>
              <tr><td><strong>Date:</strong></td><td>${formData.date || 'N/A'}</td></tr>
              <tr><td><strong>Time:</strong></td><td>${formData.time || 'N/A'}</td></tr>
            </table>

            <div><strong>Requested Services:</strong> 
              <ul>
                ${formData.services.map((item) => `<li>${item}</li>`).join('')}
              </ul>
            </div>

         <div><strong>Requested Package:</strong> 
          ${formData.package !== 'Select a Package' ? formData.package : ''}
...
<body>
  <div class="email-container">
    ...
    <p>
      We have received your service request and will review the details promptly.
      One of our team members will contact you shortly to confirm your booking and discuss any additional details.
      If you have any urgent questions, please feel free to reach us at <a class="text-blue400" href="tel:6192191936">619-219-1936</a>. 
      Thank you again for choosing us, and we look forward to providing you with exceptional service!
    </p>
